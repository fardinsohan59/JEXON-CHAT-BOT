...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Je Xon ☜\nFacebook: https://www.facebook.com/profile.php?id=61591818532948\nWhatsApp: +393509590082",
    "admin": "He is Jubayer Islamতাকে সবাই Je Xon হিসেবে চিনে😘☺️",
    "babi": "এ তো হাছিনা হে মেরে দিলকি দারকান হে মেরি জান হে😍.",
    "chup": "তুই চুপ চুপ কর পাগল ছাগল",
    "Assalamualaikum": "Walaikumassalam❤️‍🩹",
    "fork": "https://github.com/je xon/Je Xon-CHAT-BOT.git",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌Je Xon 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
